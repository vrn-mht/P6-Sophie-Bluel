...
form.addEventListener("submit", async (e) => {
  ...
  try {
      ...
      if (response.ok) {
          ...
          // Traiter le succès de l'envoi de l'image
          handleImageUploadSuccess();

          // Afficher un message d'alerte pour indiquer que l'image a été ajoutée avec succès
  ...
  trashAll.forEach((trash) => {
    trash.addEventListener("click", async (e) => {
      ...
      try {
        ...
        // Réafficher les images dans la modale après suppression
        await imgDisplay();
      } catch (error) {
